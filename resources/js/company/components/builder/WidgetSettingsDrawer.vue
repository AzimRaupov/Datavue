...
/*
 * Строки конструктора (join'ы, метрики, измерения, фильтры, сортировка)
 * набраны плотной Bootstrap-сеткой без адаптива (col-3, col-2 и т.п.) —
 * на телефоне шторка занимает весь экран (см. .widget-drawer в app.css),
 * но сами поля внутри неё всё равно жмутся в несколько колонок и становятся
 * нерабочими. Ниже sm складываем такие строки в одну колонку.
 */
@media (max-width: 575.98px) {
    .widget-drawer-body .row > [class*="col-"] {
        flex: 0 0 100%;
        max-width: 100%;
    }
}
